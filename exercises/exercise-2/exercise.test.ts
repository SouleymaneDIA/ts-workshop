...
//    * ======================================================*/
   type FixThisType = "hello" | "world" | "goodnight" | "moon";
...
//    * ======================================================*/
   type FixThisType =  string | number | true;
...
//    * ======================================================*/
   type FixThisType = boolean | "this string" | "not that string" | null  ;
...
//    * ======================================================*/
  type Earthling = { type: "animal" | "vegetable" | "mineral",
                     name: "Fido" | "Suki" | "Zucchini" | "Rose" | "Quartz" | "Diamond"
                    };
   ...
   * ======================================================*/
  type EarthlingOrAlien = { name : "Fernando" | "Mac",  
                            homePlanet?: "Pluto",
                            phaser?: true } | { name : "Fernando" | "Mac",  type: "animal"}
...
test("basic intersection", () => {
   ...
   * ======================================================*/
  const sukiTheCat: PetCat = {name: "Mili", familyName: "Meow", animalType: "cat", breedName : "cassi", coloration: "tabby"};
  const finnTheDog: PetDog = {name: "Mili", familyName: "Meow", animalType: "dog", breedName : "cassi", size: "toy"};
...
test("type narrowing and exhaustiveness", () => {
  ...
  function isBanana(fruit: 'banana' | 'apple' | 'pear') {
   if(fruit === "banana" || fruit === "apple" || fruit === "pear"){
      if (fruit === "banana") {
  ...
  function describeNumber(num: number): string {
    // The compiler warns that there is a code path that dosen't return a value
...
test("working with discriminated unions", () => {
   ...
   * ======================================================
   */
  function describe( drink: HotDrink ): "green" | "black" | "herbal" | "dark" | "medium" | "light" {
    if(drink.type === "tea"){
      return drink.style;
    }
    else{
...
test("combining unions & intersections", () => {
   ...
   * ======================================================
   */
  type Pet = Cat & PetInfo | Dog & PetInfo;
   ...
   * ======================================================
   */
  function announcePetDetail(pet: Pet) : string{
    
      if(pet.animalType === "cat"){
        
        return `This is the ${pet.familyName} family cat, ${pet.name} the ${pet.coloration} ${pet.breedName}.`; 
      }
      else{
          
        return `This is the ${pet.familyName} family dog, ${pet.name} the ${pet.size} ${pet.breedName}.`;
      }
  }
